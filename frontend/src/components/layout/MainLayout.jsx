...
export default function MainLayout() {
  ...
  const getMenuLinks = () => {
    ...
    const links = [
      ...
      { label: 'Calendario', icon: <CalendarIcon />, path: '/appointments/calendar', roles: ['Cliente', 'Recepcionista', 'Veterinario', 'Groomer'] },
      { label: 'Inventario', icon: <InventoryIcon />, path: '/inventory', roles: ['Admin', 'Recepcionista', 'Veterinario', 'Groomer'] },
      { label: 'Registrar Producto', icon: <InventoryIcon />, path: '/inventory/products/new', roles: ['Admin'] },
      { label: 'Punto de Venta', icon: <POSIcon />, path: '/pos', roles: ['Recepcionista'] },
