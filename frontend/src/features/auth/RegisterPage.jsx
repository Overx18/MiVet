      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
        ...
        <form autoComplete="off" onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <input type="text" {...register('firstName', { required: 'El nombre es obligatorio' })} className="w-full px-3 py-2 border rounded-md" autoComplete="new-password"/>
            {errors.firstName && <p className="text-sm text-red-600">{errors.firstName.message}</p>}
          </div>
          <div>
            <label className="block text-sm font-medium">Apellido</label>
            <input type="text" {...register('lastName', { required: 'El apellido es obligatorio' })} className="w-full px-3 py-2 border rounded-md" autoComplete="new-password"/>
          ...
          <div>
            ...
            <input type="password" {...register('password', { required: 'La contraseña es obligatoria', minLength: { value: 6, message: 'Mínimo 6 caracteres' } })} className="w-full px-3 py-2 border rounded-md" autoComplete="new-password"/>
